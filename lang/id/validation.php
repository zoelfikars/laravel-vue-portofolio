...
return [
    ...
    */
    ...
    'max'             => [
        'numeric' => ':Attribute tak boleh lebih dari :max.',
        'file'    => ':Attribute tak boleh lebih dari :max kilobita.',
        'string'  => ':Attribute tak boleh lebih dari :max karakter.',
        'array'   => ':Attribute tak boleh lebih dari :max anggota.',
    ],
    ...
    | cepat untuk menentukan baris bahasa kustom yang spesifik untuk aturan
    | atribut.
    |
    */
    ...
    | 'Alamat Surel' daripada 'email'. Hal ini membantu kita dalam membuat
    | pesan menjadi lebih ekspresif.
    |
    */
